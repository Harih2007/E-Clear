...
export default function LoginECentrePage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            const res = await api.post("/auth/login", { email, password, role: "ECENTRE" });
        ...
        <div className="flex items-center justify-center min-h-screen p-6" style={{ backgroundColor: '#0B0F0E' }}>
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    >
                        Login to manage pickups and collections
                    </motion.p>
                </div>
                ...
                <motion.div 
                    ...
                    <form onSubmit={handleLogin} className="space-y-6 flex-1 flex flex-col">
                        ...
                        <Button 
                            ...
                            {loading ? "Logging in..." : "Login as E-Centre"}
                ...
                >
                    <p className="text-gray-400 text-sm">
                        Need to register your E-Centre?{" "}
